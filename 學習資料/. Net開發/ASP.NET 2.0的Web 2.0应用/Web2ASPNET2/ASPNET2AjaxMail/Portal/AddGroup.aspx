<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGroup.aspx.cs" Inherits="Portal_AddGroup" StylesheetTheme="Web2ASPNET2" %>
    ...
    <asp:UpdatePanel ID="upForm" runat="server" RenderMode="Inline">
		<ContentTemplate>
			<table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
				<tr>
					<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="添加新组" /></td>
				</tr>		
				<tr>
