<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateGroup.aspx.cs" Inherits="Portal_UpdateGroup" StylesheetTheme="Web2ASPNET2" %>
    ...
    <asp:UpdatePanel ID="upForm" runat="server" RenderMode="Inline">
		<ContentTemplate>
			<table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
				<tr>
					<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="编辑组的属性" /></td>
				</tr>		
				<tr>
