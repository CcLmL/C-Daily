<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateLinkman.aspx.cs" Inherits="Portal_UpdateLinkman" StylesheetTheme="Web2ASPNET2" %>
    ...
    <asp:UpdatePanel ID="upForm" runat="server" RenderMode="Inline">
		<ContentTemplate>
			<table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
				<tr>
					<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="编辑联系人的属性" /></td>
				</tr>		
				<tr>
				...
				<tr>
					<td width="150" height="30" valign="middle" class="LeftTD" align="right">
						所属组:</td>
					<td valign="middle"><asp:DropDownList ID="ddlGroup" runat="server" SkinID="ddlSkin" Width="300px" Enabled="False"></asp:DropDownList>
					</td>
				</tr>		
				<tr>
					<td width="150" height="30" valign="middle" class="LeftTD" align="right">
