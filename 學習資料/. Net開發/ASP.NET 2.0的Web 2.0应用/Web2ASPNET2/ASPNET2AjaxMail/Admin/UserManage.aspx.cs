...
public partial class Admin_UserManage:System.Web.UI.Page
{
	...
	{   ///绑定控件的数据
		Web2ASPNET2.ASPNET2AjaxMail.User user = new Web2ASPNET2.ASPNET2AjaxMail.User();
		Web2ASPNET2.CommonOperation.DataBinder.BindGridViewData(
			gvUser,user.GetUsersByDS());
	}
	...
	protected void gvUser_RowCommand(object sender,GridViewCommandEventArgs e)
	{
		...
		{   ///执行删除操作
			Web2ASPNET2.ASPNET2AjaxMail.User user = new Web2ASPNET2.ASPNET2AjaxMail.User();
			user.DeleteUser(DataTypeConvert.ConvertToInt(e.CommandArgument.ToString()));
			///重新绑定控件数据
			BindPageData();
		}
	}
