<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateDirectory.aspx.cs" Inherits="Portal_UpdateDirectory" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="修改目录属性" /></td>
		</tr>		
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">目录名称:</td>
		...
		<tr>
			<td width="150" height="30" valign="top" class="LeftTD" align="right">备注信息:</td>
