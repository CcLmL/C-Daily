<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchByUser.aspx.cs" Inherits="Portal_Search_SearchByUser" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		...
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">选择用户:</td>
			<td valign="middle"><asp:DropDownList ID="ddlUser" runat="server" SkinID="ddlSkin" Width="300px"></asp:DropDownList><asp:Button ID="btnSearch" runat="server" Text="搜索" CssClass="Button" OnClick="btnSearch_Click" SkinID="btnSkin" Width="60px" />
			</td>
		</tr>	
		<tr>
			<td colspan="2">
