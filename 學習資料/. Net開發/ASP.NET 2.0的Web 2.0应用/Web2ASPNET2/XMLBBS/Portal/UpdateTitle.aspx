<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateTitle.aspx.cs" Inherits="Portal_UpdateTitle" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="修改帖子属性" /></td>
		</tr>		
		<tr>
		...
		<tr>
			...
			<td valign="middle"><asp:Button ID="btnDeleteAttachment" runat="server" Text="删除附件" CausesValidation="False" CssClass="Button" SkinID="btnSkin" OnCommand="btnDeleteAttachment_Command" /></td>
		</tr>	
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
