<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendMessageBox.aspx.cs" Inherits="Portal_Message_SendMessageBox" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ucMsgTitle" runat="server" Title="已发送的短消息" /></td>
		</tr>	
		<tr>
			<td colspan="2">
				<asp:GridView ID="gvMessage" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" Width="100%" SkinID="gvSkin" PageSize="30" DataKeyNames="ID" OnRowCommand="gvMessage_RowCommand" OnRowDataBound="gvMessage_RowDataBound">
					...
					<Columns>
						...
						<asp:BoundField DataField="Reciever" HeaderText="接收者" >
							<ItemStyle Width="14%" />
						</asp:BoundField>
						...
						<asp:TemplateField HeaderText="操作">
							<ItemTemplate>
								<a href='FollowMessage.aspx?MessageID=<%# Eval("ID") %>' target="_blank">跟踪短消息</a>&nbsp;&nbsp;
					...
					<HeaderStyle Font-Names="Tahoma" HorizontalAlign="Center" /><EmptyDataRowStyle ForeColor="Blue" />
