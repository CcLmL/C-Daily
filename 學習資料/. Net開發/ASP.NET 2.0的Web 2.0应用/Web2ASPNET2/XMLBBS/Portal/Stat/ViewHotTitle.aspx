<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewHotTitle.aspx.cs" Inherits="Portal_Stat_ViewHotTitle" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ucMsgTitle" runat="server" Title="热门帖子排行" /></td>
		</tr>		
		<tr>
			<td colspan="2">
