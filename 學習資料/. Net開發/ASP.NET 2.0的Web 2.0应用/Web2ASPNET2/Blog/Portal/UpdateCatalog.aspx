<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateCatalog.aspx.cs" Inherits="Portal_UpdateCatalog" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="修改文章分类" /></td>
		</tr>		
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">文章分类名称:</td>
		...
		<tr>
			...
			<td valign="middle"><asp:DropDownList ID="ddlFlag" runat="server" SkinID="ddlSkin" Width="300px">
				...
				<asp:ListItem Value="2">由文章决定</asp:ListItem>
			</asp:DropDownList>
			</td>
		</tr>	
		<tr>
