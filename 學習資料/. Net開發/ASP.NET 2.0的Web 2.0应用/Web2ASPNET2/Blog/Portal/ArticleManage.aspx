			...
			<td colspan="2">
				<asp:GridView ID="gvArticle" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" Width="100%" SkinID="gvSkin" DataKeyNames="ID" OnRowCommand="gvArticle_RowCommand" OnRowDataBound="gvArticle_RowDataBound">
					...
					<Columns>
						...
						<asp:BoundField DataField="CatalogName"  ItemStyle-Width="20%" HeaderText="所属文章种类"/>
						...
						<asp:TemplateField HeaderText="操作" ItemStyle-Width="10%">
							<ItemTemplate>
								<asp:ImageButton ID="ibtComment" runat="server" CommandName="comment" ImageUrl="../App_Themes/Web2ASPNET2/Images/add.gif" AlternateText="管理文章的评论" CommandArgument='<%# Eval("ID") %>' />&nbsp;&nbsp;
								<asp:ImageButton ID="ibtSource" runat="server" CommandName="source" ImageUrl="../App_Themes/Web2ASPNET2/Images/url.gif" AlternateText="管理文章的访问来源" CommandArgument='<%# Eval("ID") %>' />&nbsp;&nbsp;
