<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleCommentManage.aspx.cs"  Inherits="Portal_ArticleCommentManage" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="管理文章评论" /></td>
		</tr>
		<tr>
			<td colspan="2">
				<asp:GridView ID="gvComment" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" Width="100%" SkinID="gvSkin" DataKeyNames="ID" OnRowCommand="gvComment_RowCommand" OnRowDataBound="gvComment_RowDataBound">
					...
					<Columns>
						<asp:TemplateField ItemStyle-Width="34%" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left" HeaderText="URL">
							<ItemTemplate>
								<a href='ViewComment.aspx?CommentID=<%# Eval("ID") %>' target="_blank"><%# Eval("Name") %></a>								
							</ItemTemplate>
						</asp:TemplateField>
						<asp:BoundField DataField="Username"  ItemStyle-Width="16%" HeaderText="评论用户"/>
