<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddUrl.aspx.cs" Inherits="Portal_AddUrl" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="添加新链接" /></td>
		</tr>		
		<tr>
		...
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
				所属分类:</td>
			<td valign="middle"><asp:DropDownList ID="ddlCatalog" runat="server" SkinID="ddlSkin" Width="300px"></asp:DropDownList>
			</td>
		</tr>	
		<tr>
			<td width="150" height="30" valign="top" class="LeftTD" align="right">
				链接地址:</td>
			<td valign="middle"><asp:TextBox ID="tbUrl" CssClass="TextBox" runat="server" SkinID="tbSkin" MaxLength="255" Width="100%"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbName"	ErrorMessage="不能为空。" Display="Dynamic"></asp:RequiredFieldValidator>
			</td>
		</tr>	
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
