...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="添加新RSS源" /></td>
		</tr>		
		<tr>
		...
		<tr>
			...
			<td valign="middle" width="100%">
				<asp:Button ID="btnAdd" runat="server" Text="保存" CssClass="Button" OnClick="btnAdd_Click" SkinID="btnSkin" Width="60px" />
