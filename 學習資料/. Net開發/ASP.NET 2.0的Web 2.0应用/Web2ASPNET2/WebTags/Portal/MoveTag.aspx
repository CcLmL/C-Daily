<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoveTag.aspx.cs" Inherits="Portal_MoveTag" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="移动标签" /></td>
		</tr>		
		<tr>
		...
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
				当前所属标签分类:</td>
			<td valign="middle"><asp:DropDownList ID="ddlCatalog" runat="server" SkinID="ddlSkin" Width="300px" Enabled="False"></asp:DropDownList>
			</td>
		</tr>
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
				移动后所属标签分类:</td>
			<td valign="middle"><asp:DropDownList ID="ddlNewCatalog" runat="server" SkinID="ddlSkin" Width="300px"></asp:DropDownList>
			</td>
		</tr>
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
