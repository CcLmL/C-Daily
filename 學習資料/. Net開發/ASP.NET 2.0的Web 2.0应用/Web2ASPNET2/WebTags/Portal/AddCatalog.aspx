<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCatalog.aspx.cs" Inherits="Portal_AddCatalog" StylesheetTheme="Web2ASPNET2" %>
...
<body style="margin:0;border:0" class="Body">
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		<tr>
			<td colspan="2"><ucTitle:ModuleTitle ID="ModuleTitle1" runat="server" Title="添加新标签分类" /></td>
		</tr>		
		<tr>
