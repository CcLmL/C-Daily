<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTag.aspx.cs" Inherits="Portal_AddTag" StylesheetTheme="Web2ASPNET2" %>
    ...
    <table class="Table" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
		...
		<tr>
			<td width="150" height="30" valign="top" class="LeftTD" align="right">
				标签说明:</td>
			<td valign="middle"><asp:TextBox ID="tbRemark" CssClass="TextBox" runat="server" SkinID="tbSkin" MaxLength="1000" Width="560px" Height="100px" TextMode="MultiLine"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbName"	ErrorMessage="不能为空。" Display="Dynamic"></asp:RequiredFieldValidator>
			</td>
		</tr>	
		<tr>
			<td width="150" height="30" valign="middle" class="LeftTD" align="right">
