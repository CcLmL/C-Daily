				...
				<tr>
					<td align="center" valign="middle" height="100%">
						<table border="0" width="340">
							<tr>
								<td nowrap>
                                    状态:&nbsp;<asp:Label ID="txt_progressinfo" Runat="server" /></td>
							</tr>
							<tr>
								<td nowrap>
                                    文件:&nbsp;<asp:Label ID="txt_filename" style="TEXT-OVERFLOW:ellipsis" Runat="server" Width="300" /></td>
							</tr>
						</table>
						...
						<table border="0" cellspacing="0" cellpadding="1" width="340">
							<tr>
								<td nowrap>
                                    上传速度:&nbsp;<asp:Label ID="txt_speed" Runat="server" /></td>
							</tr>
							<tr>
								<td nowrap>
                                    剩余时间:&nbsp;<asp:Label ID="txt_leftTime" Runat="server" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td align="right" nowrap><asp:Button ID="btn_ok" Text="确定" Runat="server" Width="70" />&nbsp;&nbsp;<asp:Button ID="btn_cancle" Text="取消" OnClick="btn_cancle_Click" Runat="server" Width="70" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
			</table>
		</form>
	</body>
