<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserState.ascx.cs" Inherits="controls_UserState" %>
<table style="width: 560px">
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" Text="状态名称" Width="117px"></asp:Label></td>
        <td>
            &nbsp;<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
                ErrorMessage="请填写状态名称" Width="196px"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
        <td>
        </td>
    ...
    <tr>
        <td>
            <asp:Label ID="Label2" runat="server" Text="状态列表" Width="115px"></asp:Label></td>
        <td>
            &nbsp;<asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#CCCCCC"
                ...
                <ItemTemplate>
                    状态名称:
                    <asp:Label ID="StateNameLabel" runat="server" Text='<%# Eval("StateName") %>'></asp:Label><br />
                    <br />
                </ItemTemplate>
