<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_soundSpeak.aspx.cs" Inherits="Manage_manage_soundSpeak" %>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="height: 19px; width: 274px;">
                                            ...
                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="delete" Font-Underline="False">【删除】</asp:LinkButton></td>
                                        <td style="height: 19px">
                                        </td>
                                    </tr>
                                </table>
