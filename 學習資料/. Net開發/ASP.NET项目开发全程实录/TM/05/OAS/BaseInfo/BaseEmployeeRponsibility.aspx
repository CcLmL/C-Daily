<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseEmployeeRponsibility.aspx.cs" Inherits="BaseInfo_BaseEmployeeRponsibility" %>
...
<body>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" style="width: 696px; height: 139px">
            <tr>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            CellPadding="2" GridLines="Horizontal" Height="97px" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="15" Width="697px">
